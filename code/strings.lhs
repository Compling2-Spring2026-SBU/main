...
> Cf. Chapter 15 of Sanella et al. page 147
> -}
>

> data Seq a = Empty | Cons a (Seq a) deriving (Eq, Show, Read)
...
This concatenation function follows the one in Hutton.

> concatenate :: Seq a -> Seq a -> Seq a
